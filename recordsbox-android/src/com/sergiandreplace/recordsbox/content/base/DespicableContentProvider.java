...
/**
 * This class implements a content provider with the ability to give orders to a set of minion content providers
 * <img src="http://media.tumblr.com/tumblr_m3ncfqx4XX1qlo5lc.jpg"   />
 * User: Sergi Martínez
 * Date: 24/01/13
 * Time: 23:25
 */
public abstract class DespicableContentProvider extends ContentProvider {
    ...
    HashMap<Integer, MinionContentProvider> minions=new HashMap<Integer, MinionContentProvider>();
    int minionId=0;
    ...
    /**
     * This method is a placeholder to perform all the addMinion calls in order to setup our army of minions.
     * It will be invoked on the first use of the minions
     */
    public abstract void recruitMinions();

    /**
     * Current Authority for this content provider. Must be the same than the one declared in the manifest
    ...
    /**
     * Retrieves the minion that answers to the provided uri
     * It will also invoke the recruitMinions method if they have not been
     * recruited before
